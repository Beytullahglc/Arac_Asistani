...
import 'package:arac_asistani/service/auth.dart'; // AuthService dosyasını dahil ettik

class ArizaTespitSayfa extends StatefulWidget {
  const ArizaTespitSayfa({super.key});

  @override
  State<ArizaTespitSayfa> createState() => _ArizaTespitSayfaState();
}

class _ArizaTespitSayfaState extends State<ArizaTespitSayfa> {
  ...
  Widget build(BuildContext context) {
    // AuthService ile kullanıcı bilgilerini alıyoruz
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            // Kullanıcının ismini burada ekliyoruz
            DrawerHeader(
